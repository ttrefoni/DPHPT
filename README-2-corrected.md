...
3. [Implementation Guidance](#implementation-guidance)
    - [Part 1: Set Up](#part-1-set-up)
        ...
        - [B. Set Up Linux Environment](#b-set-up-linux-environment)
            - [i. Create a shared, mounted folder across Linux instances](#i-create-a-shared-mounted-folder-across-linux-instances)
        ...
        - [C. Set Up Docker](#c-set-up-docker)
            ...
            - [ii. Identify or Create Docker Image](#ii-identify-or-create-docker-image)
                ...
                - [Option 2: Create a new Docker image](#option-2-create-a-new-docker-image)
    - [Part 2: Execution](#part-2-execution)
        - [A. Create Configuration Files](#a-create-configuration-files)
        - [B. Run Docker Containers](#b-run-docker-containers)
    - [Part 3: Monitoring and Evaluation](#part-3-monitoring-and-evaluation)
        - [A. Monitor Training Progress](#a-monitor-training-progress)
        - [B. Evaluate Model Performance](#b-evaluate-model-performance)
    - [Part 4: Optimization](#part-4-optimization)
        - [A. Perform Early Stopping](#a-perform-early-stopping)
        - [B. Fine-tune Hyperparameters](#b-fine-tune-hyperparameters)
1. [A Docker Approach to Parallel Hyper-Parameter Tuning](#a-docker-approach-to-parallel-hyper-parameter-tuning)
2. [Project Background](#project-background)
3. [Implementation Guidance](#implementation-guidance)
