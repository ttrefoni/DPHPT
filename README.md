...
3. [Implementation Guidance](#detailed-implementation-guidance)
    - [Part 1: Set Up](#part-1-set-up)
        ...
        - [C. Set Up Docker](#c-set-up-docker)
            - [i. Create Docker Account](#3ci-create-docker-account)
            - [ii. Identify or Create Docker Image](#1cii-identify-or-create-docker-image)
    ...
    - [Part 3: Initialize and Execute Using Shell Script](#part-3-initialize-and-execute-using-shell-script)
        - [A. Set Up Shell Script](3A-set-up-shell-script)
        - [B. Run Shell Script](3B-run-shell-script)
