...
Github does not provide a native method to downloading directories, however user [fregante](https://stackoverflow.com/users/288906/fregante) has provided a convient solution. To download the [template](template) directory, simply paste its url into the following link: [https://download-directory.github.io/]. 
